...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white"><h4 class="mb-0"><i class="bi bi-plus-circle"></i> เพิ่มบุคลากรผลงาน (ตามหน่วยงาน)</h4></div>
        <div class="card-body">
            <form action="{{ route('frontend.rdbpublishedpersonneldep.store') }}" method="POST">
                @csrf
                <div class="row">
