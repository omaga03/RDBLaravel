...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white"><h4 class="mb-0"><i class="bi bi-pencil"></i> แก้ไขหลักสูตร</h4></div>
        <div class="card-body">
            <form action="{{ route('frontend.rdbdepartmentcourse.update', $item->depcou_id) }}" method="POST">
                @csrf @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('cou_name') is-invalid @enderror" id="cou_name" name="cou_name" value="{{ old('cou_name', $item->cou_name) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cou_name_sh" name="cou_name_sh" value="{{ old('cou_name_sh', $item->cou_name_sh) }}">
                </div>
                <div class="mt-4">
