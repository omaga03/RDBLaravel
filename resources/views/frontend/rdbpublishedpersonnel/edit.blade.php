...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white"><h4 class="mb-0"><i class="bi bi-pencil"></i> แก้ไขบุคลากรผลงาน</h4></div>
        <div class="card-body">
            <form action="{{ route('frontend.rdbpublishedpersonnel.update', $item->personnel_id) }}" method="POST">
                @csrf @method('PUT')
                <div class="row">
