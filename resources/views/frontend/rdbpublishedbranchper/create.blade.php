...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white"><h4 class="mb-0"><i class="bi bi-plus-circle"></i> เพิ่มเปอร์เซ็นต์สาขา</h4></div>
        <div class="card-body">
            <form action="{{ route('frontend.rdbpublishedbranchper.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="branchper_percent" name="branchper_percent" value="{{ old('branchper_percent') }}">
                </div>
                <div class="mt-4">
