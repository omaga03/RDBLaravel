...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white"><h4 class="mb-0"><i class="bi bi-pencil"></i> แก้ไขตำแหน่งในโครงการ</h4></div>
        <div class="card-body">
            <form action="{{ route('frontend.rdbprojectposition.update', $item->position_id) }}" method="POST">
                @csrf @method('PUT')
                <div class="mb-3">
                    <label for="position_nameTH" class="form-label">ชื่อตำแหน่ง <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('position_nameTH') is-invalid @enderror" id="position_nameTH" name="position_nameTH" value="{{ old('position_nameTH', $item->position_nameTH) }}" required>
