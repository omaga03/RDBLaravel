...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white"><h4 class="mb-0"><i class="bi bi-pencil"></i> แก้ไขบุคลากรโครงการ (ตามหน่วยงาน)</h4></div>
        <div class="card-body">
            <form action="{{ route('frontend.rdbprojectpersonneldep.update', $item->ppd_id) }}" method="POST">
                @csrf @method('PUT')
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="pp_num" name="pp_num" value="{{ old('pp_num', $item->pp_num) }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="pp_standard" class="form-label">มาตรฐาน</label>
                        <input type="number" class="form-control" id="pp_standard" name="pp_standard" value="{{ old('pp_standard', $item->pp_standard) }}">
                    </div>
                </div>
                <div class="mt-4">
