...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white"><h4 class="mb-0"><i class="bi bi-pencil"></i> แก้ไขสาขาวิชา</h4></div>
        <div class="card-body">
            <form action="{{ route('frontend.rdbdepmajor.update', $item->maj_code) }}" method="POST">
                @csrf @method('PUT')
                <div class="mb-3">
                    <label for="maj_id" class="form-label">รหัสสาขา</label>
                    <input type="text" class="form-control" id="maj_id" name="maj_id" value="{{ old('maj_id', $item->maj_id) }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('maj_nameTH') is-invalid @enderror" id="maj_nameTH" name="maj_nameTH" value="{{ old('maj_nameTH', $item->maj_nameTH) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="maj_nameEN" name="maj_nameEN" value="{{ old('maj_nameEN', $item->maj_nameEN) }}">
                </div>
                <div class="mt-4">
