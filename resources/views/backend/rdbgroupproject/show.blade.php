...
<div class="py-4">
    <x-page-header 
        title="รายละเอียดกลุ่มโครงการ"
        icon="bi-collection"
        :backRoute="route('backend.rdbgroupproject.index')"
        :editRoute="route('backend.rdbgroupproject.edit', $item->pgroup_id)"
        :deleteRoute="route('backend.rdbgroupproject.destroy', $item->pgroup_id)"
    ...
    <div class="row">
        <div class="col-lg-6">
            <x-card title="ข้อมูลกลุ่มโครงการ" icon="bi-info-circle" color="primary">
                <table class="table table-borderless table-sm mb-0">
                    ...
                    <tr>
                        <th>ชื่อ (ภาษาไทย):</th>
                        <td class="fw-bold fs-5">{{ $item->pgroup_nameTH ?? '-' }}</td>
                    </tr>
                    <tr>
